...
function CalcularPrecio() {
    ...
    } else if (cantidad === 5 && marca === ARGENTINA_LUZ) {
    ...
    } else if (cantidad === 4 && (marca === ARGENTINA_LUZ || marca === FELIPELAMPARAS)) {
    ...
    } else if (cantidad === 3 && marca === ARGENTINA_LUZ) {
    ...
    if (vCalculo > 120) {
        ...
        vCalculo = parseInt(vIngresoBruto + vCalculo).toFixed(2);
